...
namespace ShopSite_Blazor.Server.Migrations
{
    ...
    [Migration("20220522035851_ProductVariants")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopSite_Blazor.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopSite_Blazor.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("ShopSite_Blazor.Shared.ProductVariant", b =>
                {
                    b.HasOne("ShopSite_Blazor.Shared.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShopSite_Blazor.Shared.ProductType", "ProductType")
                        .WithMany()
