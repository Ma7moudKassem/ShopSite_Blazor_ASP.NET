    ...
    public partial class SeedingMoreProducts : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { "Available at a lower price from other sellers that may not offer free Prime shipping.", "https://m.media-amazon.com/images/I/311AAjeId7L._AC_.jpg", 1795m, "Sony PlayStation 5" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { "This product is intended for EU Region.  This CD Key will not work if your PS5 is not in EU region", "https://www.cjs-cdkeys.com/product_images/p/21371.jpg", 1200m, "FIFA 22 PSN" });
